...
<table class="table table-striped">
    <thead>
        <tr>
            <td class="bg-info text-light" colspan="4">
...
?>
    ...
    <?php if ($rsbank != NULL){ ?>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th colspan="2" class="bg-info text-light">
            ...
            <tbody>
                <tr>
                    ...
                    <td width="70%">
                        <p> คลิกปุ่มนี้หาก <button type="button" onclick="if(chkfirm('คุณต้องการดำเนินการต่อหรือไม่')==true){window.location='order_detail.php?action=statusyes&orderID=<?php echo $rs_order['orderID'] ?>'}" <?php if ($rs_order['status'] == 'yes') {
                                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                                } ?> class="btn btn-primary">ชำระเงินแล้ว</button></p>
                        <p> คลิกปุ่มนี้หาก <button type="button" onclick="if(chkfirm('คุณต้องการดำเนินการต่อหรือไม่')==true){window.location='order_detail.php?action=statusno&orderID=<?php echo $rs_order['orderID'] ?>'}" <?php if ($rs_order['status'] == 'no') {
                                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                                } ?> class="btn btn-danger">ยังไม่ชำระเงิน</button></p>
                    </td>
                </tr>
                <tr>
