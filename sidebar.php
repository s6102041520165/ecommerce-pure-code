      ...
      <ul class="list-group list-group-flush">
        ...
        ?>
          <li class="list-group-item">
            ...
            <a class="btn btn-primary btn-sm" href="details.php?proID=<?php echo $rsavg->proID ?>">รายละเอียด</a>
          </li>
        <?php } ?>
      </ul>
    </div>
      ...
      <ul class="list-group list-group-flush">
        ...
        ?>
          <li class="list-group-item">
            ...
            <a class="btn btn-primary btn-sm" href="details.php?proID=<?php echo $rs_new->proID ?>">รายละเอียด</a>
          </li>
        <?php } ?>
      </ul>
    </div>
